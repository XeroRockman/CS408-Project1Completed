    ...
    public void resetView() {
        ...
        for (int row = 0; row < size; ++row) {
            for (int col = 0; col < size; ++col) {
                ...
                TextView t = (TextView) findViewById(id); t.setText("");
            }
        }
    }
    ...
    public void modelPropertyChange(final PropertyChangeEvent e) {
        ...
        if ( (propertyName.equals(TicTacToeController.SET_SQUARE_X)) ||
            ...
            if (propertyValue instanceof TicTacToeSquare) {
                //
                String updatedPropertyString = controller.getMarkAsString((TicTacToeSquare) propertyValue);
                int id = getSquareId((TicTacToeSquare) propertyValue);
                TextView t = (TextView) findViewById(id);
                t.setText(updatedPropertyString);
            }
